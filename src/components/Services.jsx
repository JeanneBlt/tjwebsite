            ...
            <div className="container">
                    ...
                    <div className="col-span-1 md:col-span-3 service group relative flex px-3 py-5 rounded-md duration-300 hover:bg-gray-50 before:absolute before:left-10 before:top-9 before:h-[calc(100%-60px)] before:w-[1px] before:bg-gray-300 after:absolute after:left-9 after:bottom-4 after:h-[10px] after:w-[10px] after:rounded-full after:bg-gray-300">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col md:flex-row">
                                <p className="mr-2 mb-1 md:mb-0 font-semibold"><span className="date-placeholder">From February 2024 to June 2024</span></p>
                                <p className="md:mb-0"><span className="font-semibold">ESIEE / National Taipei University of Technology at Taipei, Taiwan</span><br />Internationnal exchange student in Master in IT</p>
                            </div>
                            <div className="flex flex-col md:flex-row">
                                <p className="mr-2 mb-1 md:mb-0 font-semibold"><span className="date-placeholder">Since September 2021</span></p>
                                <p className="md:mb-0"><span className="font-semibold">ESIEE Paris Noisy-Le-Grand</span><br />5th year of engineering cycle</p>
                            </div>
                            <div className="flex flex-col md:flex-row">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                    {Array.isArray(otherServices) && otherServices.map(service => (
                        <Service
                            key={service.id}
                            desc={service.desc}  // Desc contient le HTML
                            title={service.title}
